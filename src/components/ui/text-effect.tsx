/** biome-ignore-all lint/suspicious/noArrayIndexKey: Character animations have static, non-reordering items */
"use client";
import {
	AnimatePresence,
	motion,
...
const AnimationComponent: React.FC<{
	...
	const content = getAnimationContent(segment, variants, per);
